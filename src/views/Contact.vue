<template>
  <div>
    ...
    <div style="margin-bottom:40px;">I'm looking for a job!<br/>Feel free to contact me about any opportunity, or just to chat about games, music or anything else.</div>
    ...
    <ul>
      ...
      <li>
        ...
        <a href="mailto:nilesdorn@gmail.com" target="_blank">nilesdorn@gmail.com</a>
      </li>
      <li>
        <i class="fa fa-linkedin fa-lg fa-fw" style="vertical-align: -5%;"></i>
        <a href="https://www.linkedin.com/in/nilesdorn" target="_blank">linkedin.com/in/nilesdorn</a>
      </li>
      <li>
        <i class="fa fa-github fa-lg fa-fw"></i>
        <a href="https://github.com/nilesdorn" target="_blank">github.com/nilesdorn</a>
      </li>
      <!--<li>
